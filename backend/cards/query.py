...
FIELDS: dict[str, Field] = {
    # Texto
    "name": Field("Card Name", "text", ("name", "back_name"), "Text"),
    "text": Field("Card Text", "text", ("effect_text",), "Text", normalized=True),
    "card_number": Field("Card Number", "text", ("card_number",), "Text"),
    # Set
    "series": Field("Series", "enum", ("series",), "Set", facet=True),
    "set_code": Field("Set Code", "enum", ("set_code",), "Set", facet=True),
    "card_set": Field("Card Set", "enum", ("card_set",), "Set", facet=True),
    "regulation": Field("Regulation", "array", ("regulations",), "Set", facet=True),
    "legality": Field("Banned / Limited", "enum", ("legality",), "Tournament", facet=True),
    # card_config
    "type": Field("Type", "enum", ("card_type",), "Attributes", facet=True),
    "color": Field("Color", "array", ("colors",), "Attributes", facet=True),
    "rarity": Field("Rarity", "enum", ("rarity",), "Attributes", facet=True),
    "energy": Field("Energy", "number", ("energy",), "Attributes"),
    "color_cost": Field("Color Cost", "array", ("color_cost_colors",), "Attributes", facet=True),
    "combo_energy": Field("Combo Energy", "number", ("combo_energy",), "Attributes"),
    "combo_power": Field("Combo Power", "number", ("combo_power",), "Attributes"),
    "power": Field("Power", "number", ("power",), "Attributes"),
    "back_power": Field("Power (Back Side)", "number", ("back_power",), "Attributes"),
    "z_energy_cost": Field("Z-Energy Cost", "number", ("z_energy_cost",), "Attributes"),
    "character": Field("Character", "array", ("characters",), "Attributes", facet=True),
    "special_trait": Field("Special Trait", "array", ("special_traits",), "Attributes", facet=True),
    "era": Field("Era", "array", ("eras",), "Attributes", facet=True),
    "has_back": Field("Double-Sided", "boolean", ("back_id",), "Attributes"),
    # Habilidades (categorías oficiales)
    "timing": Field("Activate Timing", "array", ("timing",), "Skills", facet=True),
    "keyword_skill": Field("Keyword Skills", "array", ("keyword_skills",), "Skills", facet=True),
    "keyword_rule": Field("Keywords", "array", ("keyword_rules",), "Skills", facet=True),
    "keyword": Field("Keyword (Exact Value)", "array", ("keywords",), "Skills", facet=True),
    "keyword_mention": Field("Mentioned Keyword", "array", ("keyword_mentions",), "Skills", facet=True),
    "keyword_family": Field("Keyword Family", "array", ("keyword_families",), "Skills", facet=True),
}
